 ...
 * Reference: https:// learn.microsoft.com/en-us/dotnet/csharp/language-reference/statements/statements
 * */
...
namespace COMP003A.LectureActivity4
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("\n");// new line
            Console.WriteLine("".PadRight(50, '*'));
            Console.WriteLine("forearch statement");
            Console.WriteLine("".PadRight(50, '*'));

            // this is a simply array with 10 items in it. you will learn more about arrays on module 7
            string[] simpleArray = new string[] { "eleifend", "donec", "pretimu", "vulputate", "sapian", "nec", "sagittis", "aliquam", "malesuada", "bibendum" };
            ...
            /*
             * The while statement executes a statement or block of statements while a specified
             * Boolean expression evaluates to true. Because that expressino is evaluated before
            ...
            while (counter3 < 20)
            {
                Console.WriteLine($"\tCurrent conuter3: {counter3}");
                counter3 += 2; // add 2 to the value of counter3
            }

            Console.WriteLine("\n"); // new line
            Console.WriteLine("".PadRight(50, '*'));
            Console.WriteLine("example for loop program that conuter from 1-20 and checks if it is odd or even");
            Console.WriteLine("".PadRight(50, '*'));
